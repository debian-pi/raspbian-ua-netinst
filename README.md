...
> Configure your default locale: `dpkg-reconfigure locales` (can also be configured during installation using **locales** in [installer-config.txt](#installer-customization))  
